      ...
      <div className="flex flex-col md:flex-row mb-20 text-sm gap-4">
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p className="text-gray-600">
            Every meal is prepared with quality ingredients and packed with flavour.
          </p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Convenience</b>
          <p className="text-gray-600">
            Our simple online ordering makes it easy to browse the menu and get food fast.
          </p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Reliable Support</b>
          <p className="text-gray-600">
            Our support team is ready to help with orders, delivery updates, and special requests.
          </p>
        </div>
      </div>
